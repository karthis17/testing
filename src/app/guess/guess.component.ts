...
export class GuessComponent {
  ...
  constructor(private guesss: GuessService, private im: FunQuizzesService, private cdr: ChangeDetectorRef, private languagee: LanguageService) { }
  ...
  submit() {
    console.log(this.quizze)
    this.guesss.addQuestion(this.quizze, this.resultImage).subscribe(res => { console.log(res); });
